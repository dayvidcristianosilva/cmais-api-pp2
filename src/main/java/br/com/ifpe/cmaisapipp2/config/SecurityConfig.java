package br.com.ifpe.cmaisapipp2.config;
...
import br.com.ifpe.cmaisapipp2.seguranca.jwt.JwtAuthenticationEntryPoint;
import br.com.ifpe.cmaisapipp2.seguranca.jwt.JwtTokenAuthenticationFilter;
import br.com.ifpe.cmaisapipp2.seguranca.jwt.JwtTokenProvider;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/instituicao").permitAll()
