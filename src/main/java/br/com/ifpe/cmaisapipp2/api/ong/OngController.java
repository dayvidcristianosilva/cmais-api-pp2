...
public class OngController {
  ...
  @ApiOperation(value = "Serviço responsável por listar todas as ongs do sistema.")
  @GetMapping
  ...
  @ApiOperation(value = "Serviço responsável por obter uma ong referente ao Id passado na URL.")
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Retorna  a ong."),
